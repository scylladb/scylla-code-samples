...
// Demonstration of prepared statements. Table `catalog.mutant_data` is expected to exist!
#include <cassandra.h>
#include <iostream>
...
int main(int argc, char* argv[]) {
  ...
  if (cass_future_error_code(connect_future) == CASS_OK) {
    ...
    const char* query = "INSERT INTO catalog.mutant_data (first_name, last_name, address, picture_location) VALUES (?, ?, 'unknown', 'no picture');"; // Note the question marks
