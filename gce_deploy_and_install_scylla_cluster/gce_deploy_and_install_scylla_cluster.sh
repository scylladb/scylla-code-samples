...
U14="--image "ubuntu-1604-xenial-v20180122" --image-project "ubuntu-os-cloud""
DEB8="--image "ubuntu-1604-xenial-v20180122" --image-project "debian-cloud""
RH7="--image "ubuntu-1604-xenial-v20180122" --image-project "rhel-cloud""
VM_OS="$CENTOS7"
...
while getopts ":hnudrbp:c:z:v:s:t:" opt; do
	case $opt in
		h)  echo ""
		    ...
		    echo "-t   VM type (default: $VM_TYPE). Example: to set n1-standard-8, type '-t8'"
