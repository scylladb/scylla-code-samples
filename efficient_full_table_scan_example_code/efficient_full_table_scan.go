...
var (
	...
	queryTemplate              = kingpin.Flag("query-template", "The template of the query to run. Make sure to have 2 '%s' parameters in it to embed the token ranges").Short('q').Default(defaultQueryTemplate).String()
